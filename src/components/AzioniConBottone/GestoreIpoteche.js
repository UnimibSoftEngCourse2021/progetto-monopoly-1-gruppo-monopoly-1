...
//Funzione che gestisce l'ipoteca delle proprietà
function GestoreIpoteche(props){
  ...
  //Funzione che gestisce l'ipoteca di un terreno
  ...
  //Funzione che gestisce l'ipoteca di una stazione
  ...
  //Funzione che gestisce il riscatto di un terreno
  function riscattaTerreno(){
    ...
    //Funzione che gestisce il riscatto di una stazione
